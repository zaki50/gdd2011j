...
public final class LimitedStatesBfsSolver implements SlidePuzzleSolver {
    ...
    public LimitedStatesBfsSolver(Puzzle puzzle, int[][] distanceTable, int stepLimit, int statesLimit) {
